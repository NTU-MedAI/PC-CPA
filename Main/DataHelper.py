...
def LabelDT(drug_seqs, target_seqs, drugSeq_maxlen, targetSeq_maxLen):
    ...
    return label_drugSeqs, label_targetSeqs,drug_seqs,target_seqs
...
#shuttle
def Shuttle(drug, target, affini,smiles,proteins):
    ...
    shuttle_proteins=proteins[index]
    shuttle_smiles=smiles[index]
    shttle_drug = drug[index]
    shttle_target= target[index]
    shttle_affini = affini[index]

    return shttle_drug, shttle_target,shttle_affini,shuttle_smiles,shuttle_proteins
